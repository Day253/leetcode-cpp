...
class Solution {
private:
    TreeNode *buildTreeEx(  vector<int>::iterator preorderBegin,
        ...
        root->left = buildTreeEx(preorderBegin, preorderBegin + leftSize,
                                 inorderBegin, rootNode);
        root->right = buildTreeEx(preorderBegin + leftSize, preorderEnd,
                                  rootNode + 1, inorderEnd);
        return root;
    }
public:
    TreeNode *buildTree(vector<int> &preorder, vector<int> &inorder) {
        ...
        return buildTreeEx(preorder.begin(), preorder.end(),
...
Unlike post and in case, we need to construct tree \textbf{from head to the tail} of these two orders.
